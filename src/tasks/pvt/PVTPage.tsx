    ...
    return (
      <div className="task-page">
        ...
        <div className="task-description">
          <p>PVT (Psychomotor Vigilance Task) は注意力と反応時間を測定するテストです。</p>
          <ul>
            <li>テスト時間: 3分間</li>
            <li>画面に赤い丸が表示されたら、できるだけ早くクリックまたはスペースキーを押してください</li>
            <li>赤い丸が表示される前にクリックするとフォルススタートになります</li>
            <li>反応時間が500msを超えるとラプス(注意低下)として記録されます</li>
          </ul>
        </div>
        <button onClick={pvt.start} className="btn btn-primary btn-large">
          テスト開始
        </button>
      </div>
    );
