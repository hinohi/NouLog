    ...
    <div className="chart-container">
      ...
      <ResponsiveContainer width="100%" height={300}>
        <LineChart data={data} margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
          ...
          <YAxis yAxisId="pct" orientation="right" stroke="#aaa" fontSize={12} unit="%" />
          <Tooltip
            contentStyle={{ backgroundColor: "#333", border: "1px solid #555" }}
          />
          <Legend />
          <Line yAxisId="score" type="monotone" dataKey="absoluteScore" name="絶対スコア" stroke="#3498db" dot={{ r: 4 }} />
          <Line yAxisId="score" type="monotone" dataKey="partialScore" name="部分スコア" stroke="#2ecc71" dot={{ r: 4 }} />
          <Line yAxisId="pct" type="monotone" dataKey="mathAccuracy" name="算数正答率" stroke="#e67e22" dot={{ r: 4 }} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
